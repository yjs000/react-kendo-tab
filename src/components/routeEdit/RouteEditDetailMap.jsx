import CustomMap from "@/components/kakaoMap/CustomMap.jsx";
import { RouteEditApi } from "@/components/app/businessPlan/routeEdit/RouteEditApi.jsx";
import { Fragment, useEffect, useMemo, useRef, useState } from "react";
import { CustomOverlayMap, MapMarker, Polyline, useMap } from "react-kakao-maps-sdk";
...
const RouteEditDetailMap = ({ parentProps }) => {
    ...
    useEffect(() => {
        ...
        getRouteEditVertexMutaion.mutateAsync({ databaseDivision: "edit", routeId: popupValue.routeId }).then((res) => {
...
export default RouteEditDetailMap;
